...
# Encrypt the patient file and set the appropriate ACL for the doctors
encfs /opt/WellingtonClinic/EncryptedPatients /opt/WellingtonClinic/Patients/
...
fusermount -u "/opt/WellingtonClinic/Patients/"
